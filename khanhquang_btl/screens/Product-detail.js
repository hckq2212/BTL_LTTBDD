...
import left from '../assets/ProductDetail/Left.png';
import star from '../assets/ProductDetail/Star.png';
import emptyStar from '../assets/ProductDetail/emptyStar.png';
import search from '../assets/ProductDetail/Search.png';
import more from '../assets/ProductDetail/More.png';
import favorite from '../assets/ProductDetail/Favorite.png';
...
const productDetail = [
  {
    ...
    image: require('../assets/ProductDetail/AdiZeroAdios.png'), // default image
    price: 534.43,
    category: 'Running Shoes',
    colors: [
      { name: '#0000FF', image: require('../assets/ProductDetail/AdiZeroAdios_Blue.png') },
      { name: '#FF0000', image: require('../assets/ProductDetail/AdiZeroAdios_Red.png') },
      { name: '#000000', image: require('../assets/ProductDetail/AdiZeroAdios.png') },
    ],
    sizes: [
      { size: '5' },
      { size: '6' },
    ...
    reviews: [
      { 
        avatar: require('../assets/ProductDetail/Profile.png'),
        customerName: "James Lawson",
    ...
    const similarProducts= [
      {
        image: require('../assets/ProductDetail/NikeAirMax.png'),
        name: 'Nike Air',
        salePrice: 299.43,
        price: 534.43,
        sale: '24% Off',
...
const renderProductDetail = ({ item }) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Image source={item.image} style={{ marginBottom: 15, width:400, height:220 }} />
    ...
    <View>
      <View style={styles.personalInfo}>
        ...
        <View style={styles.rate}>
          <Text style={{ marginLeft: 5, fontWeight: 'bold' }}>{item.customerName}</Text>
          <View style={styles.rating}>
            <Image source={star} style={{ marginRight: 4 }} />
            <Image source={star} style={{ marginRight: 4 }} />
            <Image source={star} style={{ marginRight: 4 }} />
      ...
      <Text style={{ marginLeft: 15, marginBottom: 15 }}>{productDetail[0].name} are always very comfortable fit, clean and just perfect in every way.</Text>
    </View>
  );
};
...
// Main App component
const App = () => {
  const [selectedImage, setSelectedImage] = useState(productDetail[0].image);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <SafeAreaView style={styles.container}>
                ...
                <Image source={selectedImage} style={{ marginBottom: 15, width: 400, height: 220 }} />
        ...
        <View style={styles.sizeChoice}>
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.choice}>
                <TouchableOpacity
                  style={[styles.colorView, { backgroundColor: item.name }]}
                  onPress={() => handleColorSelect(item)} // Update image on color select
                />
              </View>
            )}
            horizontal={true}
        ...
        <Text style={{ marginLeft: 15, marginBottom: 15 }}>{productDetail[0].name} combines a full-length React foam midsole with a 270 Max Air unit for unrivaled comfort and a striking visual experience</Text>

...
import left from './assets/Product_detail/Left.png';
import star from './assets/Product_detail/Star.png';
import emptyStar from './assets/Product_detail/emptyStar.png';
import search from './assets/Product_detail/Search.png';
import more from './assets/Product_detail/More.png';
import favorite from './assets/Product_detail/Favorite.png';

// Sample product detail data
const productDetail = [
  {
    name: 'Nike Air',
    image: require('./assets/Product_detail/Product.png'),
    price: '$534.43',
    colors: [
      { name: '#0000FF' }, 
      { name: '#FF0000' }, 
    ...
    reviews: [
      { 
        avatar: require('./assets/Product_detail/Profile.png'),
        name: "James Lawson",
    ...
    similarProducts: [
      {
        image: require('./assets/Product_detail/shoes.png'),
        name: 'Nike Air',
        salePrice: '$299.43',
        price: '$534.43',
        sale: '24% Off',
